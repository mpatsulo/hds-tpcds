...
(SELECT
  ...
  FROM template_db.store_sales, template_db.date_dim, template_db.customer_address
  ...
  FROM template_db.web_sales, template_db.date_dim, template_db.customer_address
